...
CREATE TABLE `china` (
  `Id` int(11) NOT NULL COMMENT '（省、市、区）ID',
  `Name` varchar(40) NOT NULL COMMENT '（省、市、区）名称',
  `Pid` int(11) NOT NULL COMMENT '（省、市、区）父级ID',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='中国城市表';
...
CREATE TABLE `contract` (
  ...
  `BguserId` int(11) NOT NULL COMMENT '区级项目管理用户ID',
  `CreatTime` datetime NOT NULL COMMENT '创建合同时间',
  `ContUrl` varchar(200) NOT NULL COMMENT '合同URL',
  `ContpicURL` varchar(200) DEFAULT NULL COMMENT '合同扫描件',
  PRIMARY KEY (`ContId`)
...
CREATE TABLE `disputes` (
  ...
  `CreatTime` datetime NOT NULL COMMENT '创建纠纷时间',
  `FirmOp` varchar(200) DEFAULT NULL COMMENT '企业意见',
  `ServiceOp` varchar(200) DEFAULT NULL COMMENT '团队意见',
  `DisStatus` varchar(200) DEFAULT NULL COMMENT '纠纷处理情况',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='纠纷表';
...
-- ----------------------------
-- Table structure for extradir
-- ----------------------------
DROP TABLE IF EXISTS `extradir`;
CREATE TABLE `extradir` (
  `ExtraDirId` int(11) NOT NULL COMMENT '添加材料目录ID',
  `MaterialDirId` int(11) NOT NULL COMMENT '材料目录ID',
  `FirstUrl` varchar(200) DEFAULT NULL,
  `SecondUrl` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`ExtraDirId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='增加材料目录表';
...
CREATE TABLE `firm` (
  ...
  `PostId` varchar(11) NOT NULL COMMENT '邮政编码',
  `DocUrl` varchar(200) DEFAULT NULL COMMENT '通用材料URL',
  `OpenBank` varchar(20) DEFAULT NULL COMMENT '公司开户行',
  `Account` varchar(20) DEFAULT NULL COMMENT '公司银行账户',
...
CREATE TABLE `order` (
  ...
  `ProId` int(11) NOT NULL COMMENT '项目ID',
  `BguserId` int(11) NOT NULL COMMENT '区级项目管理用户ID',
  `TaskId` int(11) DEFAULT NULL COMMENT '任务编号（订单编号+团队编号）',
  `CreatTime` datetime NOT NULL COMMENT '创建订单时间',
  `OrderUrl` varchar(200) NOT NULL COMMENT '订单URL',
  PRIMARY KEY (`OrderId`)
...
-- ----------------------------
-- Table structure for proframe
-- ----------------------------
DROP TABLE IF EXISTS `proframe`;
CREATE TABLE `proframe` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `ProName` varchar(50) NOT NULL COMMENT '项目名称',
  `BillStandard` varchar(200) NOT NULL COMMENT '收费标准',
  `Notice` varchar(200) DEFAULT NULL COMMENT '通知',
  `MgMethod` varchar(200) NOT NULL COMMENT '管理方法',
  `PublicTitle` varchar(50) DEFAULT NULL COMMENT '公示标题',
  `PublicUrl` varchar(200) DEFAULT NULL COMMENT '公示链接',
  `MaterialDirUrl` varchar(200) NOT NULL COMMENT '材料目录URL',
  `ContractUrl` varchar(200) NOT NULL COMMENT '合同模板URL',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目框架信息表';
...
CREATE TABLE `project` (
  `ProId` int(11) NOT NULL COMMENT '项目编号',
  `ProName` varchar(50) NOT NULL COMMENT '项目具体名称',
...
CREATE TABLE `role` (
  `Id` int(11) NOT NULL,
  `RoleCode` varchar(50) NOT NULL COMMENT '角色英文名称',
  `RoleName` varchar(50) NOT NULL COMMENT '角色中文名称',
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('10', 'FirmMan', '企业管理用户', '1');
INSERT INTO `role` VALUES ('11', 'FirmCom', '企业普通用户', '1');
INSERT INTO `role` VALUES ('20', 'ServicetMan', '服务团队管理用户', '2');
INSERT INTO `role` VALUES ('21', 'ServicetCom', '服务团队普通用户', '2');
INSERT INTO `role` VALUES ('30', 'BgMan', '后台高级管理用户', '3');
INSERT INTO `role` VALUES ('31', 'BgProvMan', '后台省级项目管理用户', '3');
INSERT INTO `role` VALUES ('32', 'BgCityMan', '后台市级项目管理用户', '3');
INSERT INTO `role` VALUES ('33', 'BgCounMan', '后台区级项目管理用户', '3');
INSERT INTO `role` VALUES ('34', 'BgFinance', '后台财务用户', '3');
INSERT INTO `role` VALUES ('35', 'BgFrame', '后台框架编辑用户', '3');
...
CREATE TABLE `role_priv` (
  ...
  `PrivId` int(11) NOT NULL COMMENT '权限ID',
  PRIMARY KEY (`Id`)
...
-- ----------------------------
-- Table structure for serviceteam
-- ----------------------------
DROP TABLE IF EXISTS `serviceteam`;
CREATE TABLE `serviceteam` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(20) NOT NULL COMMENT '团队名称',
  `Address` varchar(20) NOT NULL COMMENT '团队地址',
  `Memo` varchar(11) NOT NULL COMMENT '团队备注',
  `OpenBank` varchar(20) DEFAULT NULL COMMENT '团队开户行',
  `Account` varchar(20) DEFAULT NULL COMMENT '团队银行账户',
  `AccountNo` varchar(20) DEFAULT NULL COMMENT '团队银行账号',
...
-- Records of user_bg
-- ----------------------------
INSERT INTO `user_bg` VALUES ('1', 'tian', '123', '30', '李晓华', '123456789123456787', '18329021234', '12344513', '2017-05-15 16:37:25', '0');

-- ----------------------------
-- Table structure for user_firm
-- ----------------------------
...
CREATE TABLE `user_log` (
  ...
  `UserName` varchar(11) NOT NULL COMMENT '用户名称',
  `RoleId` int(11) NOT NULL COMMENT '角色ID',
  `LoginIp` varchar(15) NOT NULL COMMENT '登录Ip',
  `OpTime` datetime NOT NULL COMMENT '操作时间',
  `OpMemo` varchar(50) NOT NULL COMMENT '操作备注',
  PRIMARY KEY (`Id`)
...
-- ----------------------------
-- Table structure for user_servicet
-- ----------------------------
DROP TABLE IF EXISTS `user_servicet`;
CREATE TABLE `user_servicet` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserName` varchar(11) NOT NULL COMMENT '登录名',
  `Password` varchar(11) NOT NULL COMMENT '登录密码',
  `SvtId` int(11) NOT NULL COMMENT '服务团队ID',
  `RoleId` int(11) NOT NULL COMMENT '用户角色ID',
  `RealName` varchar(20) NOT NULL COMMENT '真实姓名',
  `IdCard` varchar(20) NOT NULL COMMENT '身份证号码',
